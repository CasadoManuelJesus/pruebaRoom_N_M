...
class MainActivity : AppCompatActivity() {
    ...
    fun pruebaAlumno(){
        ...
        daoAlumno.addAlumno(Alumno("Aarón Moreno", 20))
    ...
    fun pruebaMatricula(){
        ...
        daoMatricula.addMatricula(Matricula(daoAlumno.getAlumno("Aarón Moreno").idAlumno,daoCurso.getCurso(2, "DAM").idCurso))
